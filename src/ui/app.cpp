...
{
    lv_obj_add_event_cb(s1_all_obj.btn_next, eventHandlerSwitchPage, LV_EVENT_CLICKED, screen2);
    lv_obj_add_event_cb(s2_all_obj.btn_next, eventHandlerSwitchPage, LV_EVENT_CLICKED, screen1);
}
